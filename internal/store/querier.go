...
type Querier interface {
	...
	GetConversationsByActorID(ctx context.Context, createdBy int64) ([]Conversation, error)
	...
	GetMessagesByActorID(ctx context.Context, createdBy int64) ([]Message, error)
	...
	GetPromptsByActorID(ctx context.Context, createdBy int64) ([]Prompt, error)
